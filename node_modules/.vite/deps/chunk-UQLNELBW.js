...
true ? Slide.propTypes = {
   ...
   */
  container: chainPropTypes(import_prop_types3.default.oneOfType([HTMLElementType, import_prop_types3.default.func]), (props) => {
    if (props.open) {
...
var Drawer = React4.forwardRef(function Drawer2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDrawer"
  });
  ...
  const {
    ...
    variant = "temporary"
  } = props, ModalProps = _objectWithoutPropertiesLoose(props.ModalProps, _excluded4), other = _objectWithoutPropertiesLoose(props, _excluded22);
  ...
  const drawer = (0, import_jsx_runtime4.jsx)(DrawerPaper, _extends({
  ...
  if (variant === "permanent") {
    return (0, import_jsx_runtime4.jsx)(DrawerDockedRoot, _extends({
  ...
  const slidingDrawer = (0, import_jsx_runtime4.jsx)(TransitionComponent, _extends({
    in: open,
  ...
  return (0, import_jsx_runtime4.jsx)(DrawerRoot, _extends({
...
true ? Drawer.propTypes = {
   ...
   * @default {}
   */
  ModalProps: import_prop_types4.default.object,
  /**
   * Callback fired when the component requests to be closed.
   *
   * @param {object} event The event source of the callback.
   ...
   */
  SlideProps: import_prop_types4.default.object,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
//# sourceMappingURL=chunk-UQLNELBW.js.map
